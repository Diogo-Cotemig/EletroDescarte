            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo e(route('password.email')); ?>" class="needs-validation" novalidate="">
                  <?php echo csrf_field(); ?>
                    ...
                    <div class="invalid-feedback">
                     <?php if($errors->get('email')): ?>
                       <code> <?php echo e($errors->get('email')); ?> </code>
                     <?php endif; ?>
                    </div>
                  </div>
                  ...
                  <p style="text-align: center;"> <a href="<?php echo e(route('admin.login')); ?>" title="voltar ao login">Voltar ao Login</a></p>
                </form>
...
<?php /**PATH C:\xampp\htdocs\EletroDescarte\resources\views/admin/auth/forgot-password.blade.php ENDPATH**/ ?>