      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <form class="form-inline mr-auto">
          ...
          <div class="search-element">
            ...
            <div class="search-result">
              ...
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="<?php echo e(asset('backend/assets/img/products/product-3-50.pnh')); ?>" alt="product">
                  oPhone S9 Limited Edition
                </a>
              </div>
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="<?php echo e(asset('backend/assets/img/products/product-2-50.pnh')); ?>" alt="product">
                  Drone X2 New Gen-7
                </a>
              </div>
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="<?php echo e(asset('backend/assets/img/products/product-1-50.pnh')); ?>" alt="product">
                  Headphone Blitz
                </a>
              </div>
              <div class="search-header">
        ...
        <ul class="navbar-nav navbar-right">
              ...
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?php echo e(asset('backend/assets/img/avatar/avatar-1.pnh')); ?>" class="rounded-circle">
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?php echo e(asset('backend/assets/img/avatar/avatar-2.pnh')); ?>" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                    <b>Dedik Sugiharto</b>
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?php echo e(asset('backend/assets/img/avatar/avatar-3.pnh')); ?>" class="rounded-circle">
                    <div class="is-online"></div>
                  </div>
                  <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?php echo e(asset('backend/assets/img/avatar/avatar-4.pnh')); ?>" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?php echo e(asset('backend/assets/img/avatar/avatar-5.pnh')); ?>" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                    <b>Alfa Zulkarnain</b>
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="<?php echo e(asset('backend/assets/img/avatar/avatar-1.pnh')); ?>" class="rounded-circle mr-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">Eletro -  Descartes</a>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <ul class="list-unstyled list-unstyled-border">
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="<?php echo e(asset('backend/assets/img/avatar/avatar-1.pnh')); ?>" alt="avatar">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="<?php echo e(asset('backend/assets/img/avatar/avatar-2.pnh')); ?>" alt="avatar">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="<?php echo e(asset('backend/assets/img/avatar/avatar-3.pnh')); ?>" alt="avatar">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="<?php echo e(asset('backend/assets/img/avatar/avatar-4.pnh')); ?>" alt="avatar">
                      <div class="media-body">
                  ...
                  <div class="row pb-2">
                    <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                      <div class="avatar-item mb-0">
                        <img alt="image" src="<?php echo e(asset('backend/assets/img/avatar/avatar-5.pnh')); ?>" class="img-fluid" data-toggle="tooltip" title="Alfa Zulkarnain">
                        <div class="avatar-badge" title="Editor" data-toggle="tooltip"><i class="fas fa-wrench"></i></div>
                      </div>
                    </div>
                    <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                      <div class="avatar-item mb-0">
                        <img alt="image" src="<?php echo e(asset('backend/assets/img/avatar/avatar-4.pnh')); ?>" class="img-fluid" data-toggle="tooltip" title="Egi Ferdian">
                        <div class="avatar-badge" title="Admin" data-toggle="tooltip"><i class="fas fa-cog"></i></div>
                      </div>
                    </div>
                    <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                      <div class="avatar-item mb-0">
                        <img alt="image" src="<?php echo e(asset('backend/assets/img/avatar/avatar-1.pnh')); ?>" class="img-fluid" data-toggle="tooltip" title="Jaka Ramadhan">
                        <div class="avatar-badge" title="Author" data-toggle="tooltip"><i class="fas fa-pencil-alt"></i></div>
                      </div>
                    </div>
                    <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                      <div class="avatar-item mb-0">
                        <img alt="image" src="<?php echo e(asset('backend/assets/img/avatar/avatar-2.pnh')); ?>" class="img-fluid" data-toggle="tooltip" title="Ryan">
                        <div class="avatar-badge" title="Admin" data-toggle="tooltip"><i class="fas fa-cog"></i></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="summary">
                    ...
                    <div class="summary-item">
                      ...
                      <ul class="list-unstyled list-unstyled-border">
                        <li class="media">
                          <a href="#">
                            <img class="mr-3 rounded" width="50" src="<?php echo e(asset('backend/assets/img/products/product-1-50.pnh')); ?>" alt="product">
                          </a>
                          <div class="media-body">
                        ...
                        <li class="media">
                          <a href="#">
                            <img class="mr-3 rounded" width="50" src="<?php echo e(asset('backend/assets/img/products/product-2-50.pnh')); ?>" alt="product">
                          </a>
                          <div class="media-body">
                        ...
                        <li class="media">
                          <a href="#">
                            <img class="mr-3 rounded" width="50" src="<?php echo e(asset('backend/assets/img/products/product-3-50.pnh')); ?>" alt="product">
                          </a>
                          <div class="media-body">
                ...
                <div class="card-body">
                  <ul class="list-unstyled list-unstyled-border">
                    ...
                    <li class="media">
                      ...
                      <img class="mr-3 rounded-circle" width="50" src="<?php echo e(asset('backend/assets/img/avatar/avatar-5.pnh')); ?>" alt="avatar">
                      <div class="media-body">
                    ...
                    <table class="table table-striped mb-0">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="#" class="font-weight-600"><img src="<?php echo e(asset('backend/assets/img/avatar/avatar-1.pnh')); ?>" alt="avatar" width="30" class="rounded-circle mr-1"> Bagus Dwi Cahya</a>
                          </td>
                          <td>
...
<?php /**PATH C:\xampp\htdocs\EletroDescarte\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>