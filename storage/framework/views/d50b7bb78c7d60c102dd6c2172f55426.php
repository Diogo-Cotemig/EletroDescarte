...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/DescartarBtn.css', 'resources/js/Descartar.js']); ?>
</head>
<body>
    <div class="container">
        <aside class="sidebar">
            ...
            <img id="logoEle" src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo Eletro Descarte" />
        </aside>
...
</html><?php /**PATH C:\xampp\htdocs\EletroDescarte\resources\views/tasks/descartar.blade.php ENDPATH**/ ?>