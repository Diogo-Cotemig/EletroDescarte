...
<head>
 ...
 <?php echo app('Illuminate\Foundation\Vite')(['resources/css/Style.css', 'resources/js/Script.js', 'resources/js/server.js']); ?>
  ...
  <link rel="icon" type="image/png" href="<?php echo e(asset('img/Eletro-DescarteLOGO.png')); ?>">
</head>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?> <?php $__env->slot('header', null, []); ?>   <?php $__env->endSlot(); ?>  <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\EletroDescarte\resources\views/tasks/logado.blade.php ENDPATH**/ ?>