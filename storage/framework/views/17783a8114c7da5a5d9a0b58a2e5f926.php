...
<head>
    ...
    <!-- Favicon -->
    <link id="favicon" rel="icon" href="<?php echo e(asset('img/imagemdalogo.png')); ?>" type="image/x-icon">
</head>
<body>
    ...
    <header>
        <div id="gmail">
            <div id="left">
                ...
                <!-- Logo -->
                <img src="<?php echo e(asset('img/Logo.png')); ?>" alt="Logo Eletro-Descarte" id="img2">
                
                <!-- Dropdown de idiomas -->
                <li id="nav-drop">
                    <button id="lingua-btn">
                        <img src="https://flagcdn.com/w20/br.png" alt="Brasil" id="bandeira-principal" />
                        <span id="seta">&#9660;</span>
                    </button>
                    <ul id="drop">
                        <li data-lang="pt"><img src="https://flagcdn.com/w20/br.png" alt="Português" />Português</li>
                        <li data-lang="es"><img src="https://flagcdn.com/w20/es.png" alt="Espanhol" />Espanhol</li>
                        <li data-lang="en"><img src="https://flagcdn.com/w20/us.png" alt="Inglês" />Inglês</li>
                    </ul>
                </li>
                ...
                <nav class="menu">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="user-profile">
                            <span id="user-name">Olá, <?php echo e(Auth::user()->name); ?></span>
                    ...
                    <a href="<?php echo e(route('assistencia')); ?>" class="btn-menu" id="ass">
                        <button id="log">Assistência</button>
                    </a>
                    <a href="<?php echo e(route('historico')); ?>" class="btn-menu" id="his">
                        <button id="log">Histórico</button>
                    </a>
                    <a href="<?php echo e(route('descartar')); ?>" class="btn-menu" id="des">
                        <button id="log2">Descartar</button>
                    </a>
                </nav>
            </div>
        </div>
    ...
    <!-- CONTEÚDO -->
    <main>
        <img src="<?php echo e(asset('img/Imagem-Pessoas-Servico.png')); ?>" alt="Pessoas em serviço" id="banner">
        ...
        <section id="sobre">
            <div id="foto">
                <img src="<?php echo e(asset('img/Imagem-Homem-Servico.png')); ?>" alt="Homem em serviço" id="pro">
            </div>
            ...
            <div id="textoo">
                ...
                <p id="pppp">
                    A Eletro-Descarte mantém parcerias estratégicas com empresas
                            que procuram serviços de reciclagem.Também trabalhamos junto
                            a empresas privadas e órgãos públicos, desenvolvendo projetos
                            de coleta seletiva e campanhas de conscientização sobre o
                            descarte correto do lixo eletrônico. 
                </p>
            </div>
            <div id="foto2">
                <img src="<?php echo e(asset('img/Ajuda-Mao.png')); ?>" alt="Mãos com ajuda" id="proo">
            </div>
        </section>
        ...
        <section id="categoria">
            ...
            <hr id="line">
            <img src="<?php echo e(asset('img/Imagem-Perifericos.png')); ?>" alt="Periféricos" id="ca">
        </section>
    </main>
   ...
   <footer>
    <div id="leftt">
        <b id="bt" data-translate-key="telefone-text">Telefone: (31)91111-1111</b>
        <b id="barrra">|</b>
        <b id="bb" data-translate-key="gmail-text">Gmail: eletrodescarte@gmail.com.br</b>
        
        <div class="social-icons">
            <a href="https://www.facebook.com/eletro_descarte">
            ...
            <a href="https://www.tiktok.com/@eletro_descarte">
...
<?php /**PATH C:\xampp\htdocs\EletroDescarte\resources\views/tasks/index.blade.php ENDPATH**/ ?>