<nav>
        ...
        <li class="user-dropdown" x-data="{ open: false }">
            ...
            <div x-show="open"
                ...
                <form method="GET" action="<?php echo e(route('historico')); ?>" class="dropdown-form">
...
<?php /**PATH C:\xampp\htdocs\EletroDescarte\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>