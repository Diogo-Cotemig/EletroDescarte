...
<head>
    ...
    <link rel="stylesheet" href="http://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0" />
         <?php echo app('Illuminate\Foundation\Vite')(['resources/css/historico.css', 'resources/js/assistec.js']); ?>
</head>
<body>

<div class="page-container">
        <a href="<?php echo e(route('EletroDescarte')); ?>" class="close-btn material-symbols-outlined">close</a>
...
</html><?php /**PATH C:\xampp\htdocs\EletroDescarte\resources\views/tasks/historico.blade.php ENDPATH**/ ?>