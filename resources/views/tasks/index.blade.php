...
<head>
    ...
    <!-- Favicon -->
    <link id="favicon" rel="icon" href="{{ asset('img/imagemdalogo.png') }}" type="image/x-icon">
</head>
<body>
        ...
        <div id="gmail">
            <div id="left">
                ...
                <nav class="menu">
                    ...
                    <a href="{{ route('assistencia') }}" class="btn-menu" id="ass">
                        <button id="log">Assistência</button>
                    </a>
                    <a href="{{ route('historico') }}" class="btn-menu" id="his">
                        <button id="log">Histórico</button>
                    </a>
                    <a href="{{ route('descartar') }}" class="btn-menu" id="des">
